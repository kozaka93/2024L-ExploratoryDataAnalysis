...
```{r}
raw(length = 2) # do przechowywania bitów
```
...
Charakterystyczną cechą R jest "rozszerzanie" krótszych wektorów tak, aby "pasowały" do najdłuższego wektora w danej operacji, a nie rzucały błąd uniemożliwiający wykonanie kodu:

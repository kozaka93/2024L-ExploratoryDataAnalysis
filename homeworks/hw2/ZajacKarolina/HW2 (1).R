...
spotify %>% 
  ...
  labs(x = "Taneczność", 
       ...
       title = "zależnośc energetyczności od tanecznośći patrząc przez pryzmat liczby artystów") +
  theme_bw() +
  theme(legend.position = "right") +
  scale_color_gradient2(low = "pink", high = "yellow", mid = "darkgreen", limits = c(1,8), midpoint = 4) + 
...
zad6 %>% 
  ...
  labs(x = "Rok", 
       y = "liczba odtworzeń", 
       fill = "najpopularniejsza piosenka w danym roku",
